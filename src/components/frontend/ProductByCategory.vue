...
<template>
    ...
    <div class="container my-5">
            <!-- loading -->
            <div v-if="store.categoryLoading" class="carousel-item active">
            ...
            <!-- empty / error -->
            <div v-else-if="!store.categoryProducts.length" class="carousel-item active">
               <div class="d-flex align-item-center justify-content-center" style="height:420px">
                  <div class="text-center">
                     <p class="text-muted mb-0">{{ store.categoryError || "No Categories available" }}</p>
                  </div>
               </div>
            </div>
            ...
            <div v-else-if="store.categoryProducts.length === 0" class="carousel-item active">
               <div class="d-flex align-item-center justify-content-center" style="height:420px">
                  <div class="text-center">
                     <p class="text-muted mb-0">No products found by this category.</p>
                  </div>
               </div>
            </div>
